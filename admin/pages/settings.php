...
<div class="wrap about-wrap">
	...
	<div id="wcdfe-settings" class="wcdfe-tabs">
		...
		<div class="wcdfe-save-settings-container">
			<input type="submit" value="<?php echo __( 'Save Settings', WCDFE_TEXTDOMAIN ); ?>" class="button button-large button-primary wcdfe-button" id="wcdfe-save-settings" name="save_settings">
...
jQuery(document).ready(function(e) {
	...
	jQuery("#wcdfe-save-settings").on('click', function(e) {
		e.preventDefault();
		jQuery("#wcdfe-error-message").html('');
		jQuery("#wcdfe-save-settings").val("Saving Settings ...");
		jQuery("#wcdfe-save-settings").addClass("is-busy");
		...
		jQuery.ajax({
			...
			success: function(response){
				...
				jQuery("#wcdfe-save-settings").val("Save Settings");
        jQuery("#wcdfe-save-settings").removeClass("is-busy");
			},
			error: function (jqXHR, exception) {
				...
				jQuery("#wcdfe-error-message").html('<div class="error"><p>' + msg + '</p></div>');
				jQuery("#wcdfe-save-settings").val("Saving Settings");
				jQuery("#wcdfe-save-settings").removeClass("is-busy");
			}
		});
